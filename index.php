  ...
  <body>
      ...
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li><a href="./show_users.php">Show all users either in CodeJob or in Gamearts</a></li>
          </ul>
        </div><!--/.nav-collapse -->
      </div>
    </nav>
    ...
    <div class="container">
      ...
      <div class="starter-template">
        <h1>CodeJob</h1>
        <p class="lead">Help you land on code jobs<br> <!--All you get is this text and a mostly barebones HTML document.</p> -->
      </div>
